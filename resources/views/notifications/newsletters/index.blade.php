...
<div class ="col-lg-12 col-md-12 ">
    ...
    <a href="http://localhost/ConstructionFirmApp/public/emails/create" class="btn btn-secondary pull-right">Create New</a></h2>
    </div>
...
<div class ="table-responsive" id = "Stable">
	...
	@if($mailPosts)
            ...
            <tr>
				...
				<td>{{$mp->status}}</td>				
                <td>
					<a href="emails/{{$mp->id}}"  id="show-btn" class="btn btn-primary ">Show</a>
				</td>
            </tr>
            @endforeach
 	@else
