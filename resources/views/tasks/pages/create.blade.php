...
<div class="col-lg-8 col-md-10 col-md-offset-2">
    <div class="card">
		...
		<h2><span class="card-category">{{ __('Add Task') }} </span> 
		<a href="{{config('app.url')}}/tasks" class="btn btn-secondary pull-right">View All</a></h2>
		</div>
	
		<div class="card-body">	
			<form class="form-horizontal singleForm" id="tasks-form1" method="post" action="tasks" data-parsley-validate>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
					  <input id="project_id" type="text"  class="form-control" name="project_id" required />
					</div>
				</div>	
