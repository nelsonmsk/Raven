			...
			<div class="row">
				...
				<div class="col-md-8 step-desc">
					...
					<div class="col-md-12 step-details">
							<div class="row form-group row-step"><span class="col-md-3"><b>Id:</b></span><span class="col-md-9 form-control text-left"> {{$mailPost->id}}</span></div>
							<div class="row form-group row-step"><span class="col-md-3"><b>To:</b></span><span class="col-md-9 form-control text-left"> {{$mailPost->to}}</span></div>
							<div class="row form-group row-step"><span class="col-md-3"><b>Cc:</b></span><span class="col-md-9 form-control text-left"> {{$mailPost->cc}}</span></div>
							<div class="row form-group row-step"><span class="col-md-3"><b>From:</b></span><span class="col-md-9 form-control text-left"> {{$mailPost->from}}</span></div>
							<div class="row form-group row-step"><span class="col-md-3"><b>Subject:</b></span><span class="col-md-9 form-control text-left"> {{$mailPost->subject}}</span></div>
							<div class="row form-group row-step"><span class="col-md-3"><b>Message:</b></span><span class="col-md-9 form-control text-left"> {{$mailPost->message}}</span></div>
							<div class="row form-group row-step"><span class="col-md-3"><b>Created:</b></span><span class="col-md-9 form-control text-left"> {{$mailPost->created_at}}</span></div>
							<div class="row form-group row-step"><span class="col-md-3"><b>Modified:</b></span><span class="col-md-9 form-control text-left"> {{$mailPost->updated_at}}</span></div>	
