	...
	<div class="col-sm-10">
      ...
      <div id="b-element" class="form-group">
		<div class="col-sm-offset-2 col-sm-10">	
		  <button type="submit" class="btn btn-primary btn-lg col-sm-3" id="save-btn" name="Update">Update <div class="fa fa-save text-white"></div></button>		
		  <a href="{{url()->previous()}}" class="btn btn-cancel btn-lg col-sm-3 col-sm-offset-1" id="cancel" name="cancel">Cancel <div class="fa fa-close text-white"></div></a>
		</div>
      </div>
  </form> 
</div> 
