...
@section('body')
  ...
  <div class="col-lg-8 col-md-10 col-md-offset-2">
    ...
    <h2><span class="card-category">{{ __('Add Picture') }} </span> 
	<a href="http://localhost/TheKateRestuarant/public/gallery" class="btn btn-default pull-right">View All</a></h2>
    </div>
	
<div class="card-body">	
    <form class="form-horizontal fileupload" id="gallery-form1" method="post" enctype="multipart/form-data" data-parsley-validate>
	...
	<div class="col-sm-10">
      <input id="image" type="file"  class="upload form-control" name="image" required />
	</div>
      </div>	  
