...
<div class="card-body">	
    <form class="form-horizontal singleForm" id="bookings-form" method="post" action="bookings" data-parsley-validate>
      ...
      <input type="hidden" value="{{csrf_token()}}" name="_token" />	
           <input type="hidden" id="id" value="{{$booking->id}}" name="id" /> 
      <label for="dor" class="col-sm-2 control-label">Date:</label>
	<div class="col-sm-10">
      <input id="dor" type="date"  class="form-control" name="dor" value="{{$booking->dor}}" required />
	</div>
      </div>
      <div class="form-group">
      <label for="rtime" class="col-sm-2 control-label">Time:</label>
	<div class="col-sm-10">
      <input id="rtime" type="time"  class="form-control" name="rtime"  value="{{$booking->rtime}}" required />
	</div>
      </div>	
      <div class="form-group">
      <label for="partySize" class="col-sm-2 control-label">Party Size:</label>
	<div class="col-sm-10">
      <input id="partySize" type="text"  class="form-control" name="partySize"  value="{{$booking->partySize}}" required />
	</div>
      </div>
      <div class="form-group">
      <label for="cName" class="col-sm-2 control-label">Customer Name:</label>
	<div class="col-sm-10">
      <input id="cName" type="text"  class="form-control" name="cName" value="{{$booking->cName}}" required />
	</div>
      </div>
      <div class="form-group">
      <label for="cPhone" class="col-sm-2 control-label">Customer Phone:</label>
	<div class="col-sm-10">
      <input id="cPhone" type="text"  class="form-control" name="cPhone"  value="{{$booking->cPhone}}" required />
	</div>
      </div>
      <div class="form-group">
	...
	<div class="col-sm-offset-2 col-sm-10">
		    <input type="hidden" id="username" value="{{$booking->username}}" name="username" />
