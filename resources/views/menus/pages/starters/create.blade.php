...
@section('body')
  ...
  <div class="col-lg-8 col-md-10 col-md-offset-2">
    ...
    <h2><span class="card-category">{{ __('Add Starter') }} </span>
	<a href="http://localhost/LawFirmApp/public/menus/starters" class="btn btn-secondary pull-right">View All</a></h2>
    </div>
	
<div class="card-body">	
    <form class="form-horizontal fileupload" id="starters-menu-form1" method="post"  enctype="multipart/form-data" data-parsley-validate>
